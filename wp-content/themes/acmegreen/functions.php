...
function my_assets() {	
	...
	wp_enqueue_style( 'google-font', 'https://fonts.googleapis.com/css2?family=Poppins:ital,wght@0,200;0,300;0,400;0,500;0,600;0,700;1,200;1,300;1,400;1,500;1,600;1,700&display=swap' ); 
	wp_enqueue_style( 'custom-main', get_template_directory_uri() . '/css/styles.css' );
...
require dirname(__FILE__) . '/class-wp-bootstrap-navwalker.php';
